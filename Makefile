...
help:
	@printf "\n"
	@printf "  $(B)terminal-gym$(R)  $(D)·  19 missions  ·  4 projects$(R)\n"
	@printf "\n"
	@printf "  $(B)start$(R)\n"
	@printf "    $(GR)make start$(R)              Launch the TUI\n"
	@printf "    $(GR)make status$(R)             Progress overview\n"
	@printf "    $(GR)make next$(R)               Jump to next mission\n"
	@printf "\n"
	@printf "  $(B)per mission$(R)  $(D)(add N=03)$(R)\n"
	@printf "    $(GR)make mission$(R)            Concept brief\n"
	@printf "    $(GR)make exercises$(R)          Hands-on exercises\n"
	@printf "    $(GR)make practice$(R)           Interactive shell session\n"
	@printf "    $(GR)make solution$(R)           Worked solutions\n"
	@printf "    $(GR)make done$(R)               Mark complete\n"
	@printf "\n"
	@printf "  $(B)projects$(R)\n"
	@printf "    $(GR)make project N=1$(R)        Open a real-world project\n"
	@printf "\n"

#!/bin/bash
# Mission 05 — Shell Expansions: Interactive Practice
...
init_mission "05" "Shell Expansions" 6

step "Coming soon"
explain "This practice session is not yet written.
In the meantime, use:
  make mission   N=05   — read the concept brief
  make exercises N=05   — work through the exercises"

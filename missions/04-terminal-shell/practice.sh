#!/bin/bash
# Mission 04 — Terminal & Shell: Interactive Practice
...
init_mission "04" "Terminal & Shell" 5

step "Coming soon"
explain "This practice session is not yet written.
In the meantime, use:
  make mission   N=04   — read the concept brief
  make exercises N=04   — work through the exercises"

#!/bin/bash
# Mission 15 — Package Management: Interactive Practice
...
init_mission "15" "Package Management" 5

step "Coming soon"
explain "This practice session is not yet written.
In the meantime, use:
  make mission   N=15   — read the concept brief
  make exercises N=15   — work through the exercises"

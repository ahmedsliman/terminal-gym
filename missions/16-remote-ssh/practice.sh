#!/bin/bash
# Mission 16 — Remote Servers & SSH: Interactive Practice
...
init_mission "16" "Remote Servers & SSH" 1

step "Coming soon"
explain "This practice session is not yet written.
In the meantime, use:
  make mission   N=16   — read the concept brief
  make exercises N=16   — work through the exercises"

#!/bin/bash
# Mission 09 — Filesystem Hierarchy: Interactive Practice
...
init_mission "09" "Filesystem Hierarchy" 5

step "Coming soon"
explain "This practice session is not yet written.
In the meantime, use:
  make mission   N=09   — read the concept brief
  make exercises N=09   — work through the exercises"
